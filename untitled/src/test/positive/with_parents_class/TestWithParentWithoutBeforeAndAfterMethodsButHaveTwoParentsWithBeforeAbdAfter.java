...
import test.positive.with_parents_class.parents.ParentClassWithBeforeAndAfterMethodsOneMore;
import test.positive.with_parents_class.parents.ParentClassWithoutBeforeAndAfterMethods;

public class TestWithParentWithoutBeforeAndAfterMethodsButHaveTwoParentsWithBeforeAbdAfter extends ParentClassWithBeforeAndAfterMethodsOneMore {
